export default function MyMenu () {
  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <img src="/image/snowman.png" className="h-8" title="Bigg Logo" />
        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Sarawut</span>
    </a>
